...
class App():
    def __init__(self):
        self.image = cv.imread('parrot.jpg')
        self.imgray = None
        self.trsh1 = None
        self.trsh2 = None
...
class Gui:
    ...
    def filt(self):
        ...
        self.label3.configure(image=self.image1)
        self.label3.image = self.image1
        self.label1.configure(text="Filter Image")

    def equalization(self):
        self.image1 = self.solution.equalization()
        self.label3.configure(image=self.image1)
        self.label3.image = self.image1
        self.label1.configure(text="Equalization Image")
    ...
    def histogram_equalization(self):
        ...
        self.label3.configure(image=self.image1)
        self.label3.image = self.image1
        self.label1.configure(text="Histogram Equalization Image")

    def linear(self):
        self.image1 = self.solution.linear()
        self.label3.configure(image=self.image1)
        self.label3.image = self.image1
        self.label1.configure(text="Linear Image")
